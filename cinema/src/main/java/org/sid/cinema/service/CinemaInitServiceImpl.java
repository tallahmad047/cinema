...
public class CinemaInitServiceImpl implements ICinemaInitService {
	...
	public void initVilles() {
		Stream.of("Linguere", "Dakar", "Fatick", "Guediawaye").forEach(nomVille -> {
	...
	public void initCinemas() {
		villeRepository.findAll().forEach(ville -> {
			Stream.of("Samba linguere", "Grand theatre", "Centrefatick", "Ravin", "pikinpatty").forEach(nomCinema -> {
	...
	public void initFilms() {
		...
		Stream.of("12 Hommes en colere", "Forrest Gump", "GreenBook", "LaLigne Verte", "LeParrain",
				"LeSeigneur des anneaux").forEach(titreFilm -> {
					Film film = new Film();
